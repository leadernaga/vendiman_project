...
function getInventoryList() {
    return __awaiter(this, void 0, void 0, function* () {
        const data = yield connection_1.default.select('*').from('inventory');
...
function get_inventory_items_data(data, inventory_id) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        return connection_1.default
            ...
            .from('inventory_items')
            .where('inventory_id', inventory_id)
            .whereIn('items.item_id', data)
            .join('items', 'items.item_id', 'inventory_items.item_id');
    });
}
function post_items_on_inventory(inventory_id, data) {
    return __awaiter(this, void 0, void 0, function* () {
        return data.map((elm, index) => __awaiter(this, void 0, void 0, function* () {
            const it = yield connection_1.default.raw(`insert into inventory_items (inventory_id,item_id,qty) values ('${inventory_id}','${elm.item_id}',${elm.qty}) on conflict(item_id) do update set qty = inventory_items.qty+${elm.qty} returning *`);
        }));
    });
}

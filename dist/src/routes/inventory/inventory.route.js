...
route.get('/list', inventory_controllers_1.default.get_list_of_inventories);
...
route.post('/items/place_order', auth_middlewere_1.default.auth_middlewere, inventory_items_controllers_1.default.place_order);
route.post('/items', auth_middlewere_1.default.admin_middlewere, inventory_items_controllers_1.default.post_inventory_items);
route.patch('/items', auth_middlewere_1.default.admin_middlewere, inventory_items_controllers_1.default.post_inventory_items);
